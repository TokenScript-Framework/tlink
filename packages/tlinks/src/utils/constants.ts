...
import { arbitrum, arbitrumGoerli, base, baseSepolia, bsc, bscTestnet, goerli, mainnet, optimism, optimismGoerli, polygon, polygonMumbai, sepolia } from "viem/chains";
...
export const wagmiProviderConfig: ReturnType<typeof getDefaultConfig> = getDefaultConfig({
    appName: "Tlink",
...
export function getRPCURL(chainId: number): string {
    const chain = getChainById(chainId);
    return (chain?.rpcUrls.default.http[0] as string) || "https://cloudflare-eth.com";
}
